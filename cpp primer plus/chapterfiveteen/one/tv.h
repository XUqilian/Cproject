...
class Remote
{
    ...
    public:
        ...
        void dismode(){ cout << "Current status:" << state << endl;}   // c 
};
...
class Tv{
    ...
    public:
        ...
        void altstate(Remote & rt){ if(statu == on) (rt.state == on) ? rt.state = off : rt.state = on ;}    // d 
